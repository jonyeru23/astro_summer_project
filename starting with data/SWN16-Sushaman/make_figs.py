...
def main():
    ...
    make_figs(data_path, folder, model, 250)
...
def get_lines_dots(flat_samples, x, y, yerr, file_path, start=0.01, end=3.5, close_up=False):
    M = Magnitude()
    plt.clf()
    ...
    for ind in inds:
        ...
        plt.plot(time, [M.convert_absolute_to_apparent(M.get_filtered_abs_mag(theta, t), distance) for t in time], "C1", alpha=0.1)
